...
const htmlSVG = document.querySelector(".html-svg");
const htmlColor1 = document.querySelector(".html-color1");
const htmlColor2 = document.querySelector(".html-color2");
const htmlColor3 = document.querySelector(".html-color3");
const htmlColor4 = document.querySelector(".html-color4");
...
const cssSVG = document.querySelector(".css-svg");
const cssColor1 = document.querySelector(".css-color1");
const cssColor2 = document.querySelector(".css-color2");
const cssColor3 = document.querySelector(".css-color3");
const cssColor4 = document.querySelector(".css-color4");
const cssColor5 = document.querySelector(".css-color5");
const cssColor6 = document.querySelector(".css-color6");
...
const jsColor1 = document.querySelector(".js-color1");
const jsColor2 = document.querySelector(".js-color2");
// REACT
